...
.hero {
  background: #133a53
    url("https://images.pexels.com/photos/1309426/pexels-photo-1309426.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940");
  /* background: url(""); */
  position: relative;
  display: flex;
  align-items: center;
