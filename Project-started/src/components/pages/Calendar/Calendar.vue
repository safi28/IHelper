                ...
                <v-card>
                  <v-container>
                    <v-form @submit.prevent="updateEvent">
                      ...
                      ></v-text-field>
                      <v-text-field v-model="selectedEvent.details" type="text" label="detail"></v-text-field>
                ...
                >
                  <v-card color="grey lighten-4" :width="350" flat>
                    ...
                    <v-card-actions>
                      ...
                      >edit</v-btn>
                      <v-btn text v-else type="submit" @click.prevent="updateEvent()">Save</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-menu>
              </v-sheet>
