    ...
    <header class="header-design">
      <div class="listar-map-button">
        <div class="listar-map-button-text" style="display: inline-block; opacity: 1;">
          <span class="icon-map2">What do we offer?</span>
        </div>
      </div>
                ...
                <div class="listar-feature-block-content-wrapper">
                  ...
                  <div class="listar-feature-content-wrapper" style="padding-top: 0px;">
                    <div class="listar-feature-item-title listar-feature-counter-added">
                      <span>
                        <span>01</span>
                        <button @click="navigateFood()">Meals</button>
                      </span>
                    </div>

                    <div
                      class="listar-feature-item-excerpt"
                    >Start tracking your daily food habit. Try new things and be healthy.</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="listar-feature-item-inner">
                ...
                <div class="listar-feature-block-content-wrapper">
                  <div class="listar-feature-icon-wrapper">
                    <div class="listar-feature-icon-inner">
                      <div>
                        <img alt="Customers" class="listar-image-icon" src="../../assets/sport.svg" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="listar-feature-content-wrapper" style="padding-top: 0px;">
                    <div class="listar-feature-item-title listar-feature-counter-added">
                      <span>
                        <span>02</span>
                        <button @click="navigateFit()">Get Fit</button>
                      </span>
                    </div>

                    <div
                      class="listar-feature-item-excerpt"
                    >Get in form and start workout. Physical health is the key to be happy.</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="listar-feature-item-inner">
                ...
                <div class="listar-feature-block-content-wrapper">
                  <div class="listar-feature-icon-wrapper">
                    <div class="listar-feature-icon-inner">
                      <div>
                        <img alt="Feedback" class="listar-image-icon" src="../../assets/list.svg" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="listar-feature-content-wrapper" style="padding-top: 0px;">
                    <div class="listar-feature-item-title listar-feature-counter-added">
                      <span>
                        <span>03</span>
                        <button @click="navigateTodo()">TODO List</button>
                      </span>
                    </div>

                    <div
                      class="listar-feature-item-excerpt"
                    >Too many things to do? Start writing your tasks for the day.</div>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    navigateTodo() {
      this.$router.push({ name: "Meistask" });
    }
  }
};
</script>
...
header .footer-wave {
  ...
  z-index: 1;
  bottom: -67px;
  /* background: url(https://1bp.blogspot.com/-NYl6L8pz8B4/XoIVXwfhlNI/AAAAAAAAU3k/nxJKiLT706Mb7jUFiM5vdCsOSNnFAh0yQCLcBGAsYHQ/s1600/hero-wave.png) */
  /* repeat-x; */
